      ...
      <div className="flex items-center space-x-4">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuLabel className="text-xs text-gray-500 font-normal">Manager</DropdownMenuLabel>
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={() => navigate("/manager/profile")}>
              <User className="mr-2 h-4 w-4" />
              <span>My Profile</span>
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => navigate("/manager/settings")}>Account Settings</DropdownMenuItem>
            <DropdownMenuSeparator />
