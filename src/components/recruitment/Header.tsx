  ...
  return (
    <header className="bg-white border-b border-gray-200 h-16 flex items-center px-6 sticky top-0 z-10">
      <div className="flex items-center flex-1">
        <h1 className="text-xl font-semibold text-gray-800 hidden md:block">Recruitment Portal</h1>
      </div>
      ...
      <div className="relative mx-4 flex-1 max-w-md hidden md:block">
        ...
        <input
          type="text"
          className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-gray-50 placeholder-gray-500 focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm"
      ...
      <div className="flex items-center space-x-4">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuLabel>Recruitment Settings</DropdownMenuLabel>
            <DropdownMenuSeparator />
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuLabel>Recruitment Manager</DropdownMenuLabel>
            <DropdownMenuSeparator />
