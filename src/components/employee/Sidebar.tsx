...
const EmployeeSidebar = () => {
  ...
  const navItems = [
    ...
    { name: "Attendance", icon: Clock, href: "/employee/attendance" },
    { name: "Payslips", icon: CreditCard, href: "/employee/payslips" },
    { name: "Leave Requests", icon: Calendar, href: "/employee/leaves" },
    { name: "Performance", icon: Star, href: "/employee/performance" },
    { name: "Announcements", icon: Bell, href: "/employee/announcements" },
  ...
  return (
    ...
    >
      <div className="flex items-center px-6 py-4 h-16 border-b border-gray-200">
        ...
        {collapsed && (
          <div className="h-8 w-8 bg-blue-500 rounded-md flex items-center justify-center mx-auto">
            <span className="text-white font-bold text-lg">E</span>
          </div>
        )}
        <Button
