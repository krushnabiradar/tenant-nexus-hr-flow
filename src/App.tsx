      ...
      <AuthProvider>
        <TooltipProvider>
          ...
          <Routes>
            ...
            {/* Employee Routes */}
            <Route element={<ProtectedRoute allowedRoles={["Employee", "HR", "Manager", "SuperAdmin"]} />}>
            ...
            {/* Manager Routes */}
            <Route element={<ProtectedRoute allowedRoles={["Manager", "HR", "SuperAdmin"]} />}>
